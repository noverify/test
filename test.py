...
def heading():
    ...
    """ + END + BLUE +
    '\n' + '{}Wirf Leute aus dem WLAN ({}Muhahahaha{}){}'.format(YELLOW, RED, YELLOW, BLUE).center(98) +
    '\n' + 'Von {0}SyFyX'.format(YELLOW, RED, YELLOW, BLUE).center(78) +
...
# display options
def optionBanner():
    print('\nNimm eine Option aus dem Menü:\n')
    sleep(0.2)
    print('\t{}[{}1{}]{} Werf einen raus'.format(YELLOW, RED, YELLOW, WHITE))
    sleep(0.2)
    print('\t{}[{}2{}]{} Werf ein paar raus'.format(YELLOW, RED, YELLOW, WHITE))
    sleep(0.2)
    print('\t{}[{}3{}]{} Werf alle raus'.format(YELLOW, RED, YELLOW, WHITE))
    sleep(0.2)
...
def runDebug():
    print("\n\n{}WARNUNG! Ein Unbekannter Fehler ist aufgetreten debug wird gestartet...{}".format(RED, END))
    print(
    "{}Debug starten... (Bitte sage den Fehler hier 'https://github.com/k4m4/kickthemout/issues'){}".format(
        RED, END))
    try:
        print("Aktuell defaultGatewayMac: " + defaultGatewayMac)
    except:
        print("Fehler beim Anzeigen defaultGatewayMac...")
    try:
        print("MAC-Retriever-Funktion neu laden...")
        regenOnlineIPs()
        print("Neu geladen defaultGatewayMac: " + defaultGatewayMac)
    except:
        print("Fehler beim Laden der MAC-Retriever-Funktion / Anzuzeigen defaultGatewayMac...")
    try:
        print("Bekannt gateway IP: " + defaultGatewayIP)
    except:
        print("Fehler beim Anzeigen defaultGatewayIP...")
    try:
        print("Absturz Pfad: ")
        print(traceback.format_exc())
    except:
        print("Fehler beim Anzeigen des Absturz Pfades...")
    print("DEBUG FERTIG.\nHerunterfahren...")
    print("{}".format(END))
    os._exit(1)
...
def nonInteractiveAttack():
    ...
    if options.packets is not None:
        print("\n{}Spoofing startet... {}( {} pkts/min )".format(GREEN, END, str(options.packets)))
    else:
        print("\n{}Spoofing startet... {}".format(GREEN, END))
    try:
        while True:
        ...
        print("\n{}Wiederherstellung{} Ziel(s)...{}".format(RED, GREEN, END))
        reArp = 1
        while reArp != 10:
            ...
            reArp += 1
            time.sleep(0.2)
        print("{}Wiederherstellung{} Ziel(e) Fertig.{}".format(RED, GREEN, END))
...
def kickoneoff():
    ...
    print("\n{}Werfe einen raus{} ausgesucht...{}\n".format(RED, GREEN, END))
    global stopAnimation
    stopAnimation = False
    t = threading.Thread(target=scanningAnimation, args=('Warten...',))
    t.daemon = True
    t.start()
    ...
    while not canBreak:
        try:
            ...
            print("\n{}ERROR: Bitte nehme eine Nummer aus der Liste{}".format(RED, END))
    ...
    print("\n{}Ziel: {}{}".format(GREEN, END, oneTargetIP))
    ...
    try:
        ...
        print("\n{}Wiederherstellung{} Ziel...{}".format(RED, GREEN, END))
        reArp = 1
        while reArp != 10:
            try:
                # broadcast ARP packets with legitimate info to restore connection
            ...
            reArp += 1
            time.sleep(0.2)
        print("{}Wiederherstellung{} Ziel Fertig.{}".format(RED, GREEN, END))
...
def kicksomeoff():
    ...
    try:
        ...
        # re-arp targets on KeyboardInterrupt exception
        print("\n{}Wiederherstellung{} Ziele...{}".format(RED, GREEN, END))
        reArp = 1
        while reArp != 10:
            # broadcast ARP packets with legitimate info to restore connection
            for i in someTargets:
            ...
            reArp += 1
            time.sleep(0.2)
        print("{}Wiederherstellung{} Ziele Fertig.{}".format(RED, GREEN, END))
...
def main():
    ...
    if interactive:
        ...
        print("\n{}Du verwendest die Schnittstelle '{}{}{}' mit der Mac-Adresse '{}{}{}'.\nGateway IP: '{}{}{}' --> {}{}{} Geräte sind im WLAN.{}".format(
        ...
        if len(hostsList) == 0 or len(hostsList) == 1:
            if len(hostsList) == 1:
                if hostsList[0][0] == defaultGatewayIP:
                    print("\n{}{}WARNING: Es gibt {}0 Hosts up{} in deinem Netzwerk außer deinem Gateway.\n\tDu kannst keinen Rauswerfen {}:/{}\n".format(
                        GREEN, RED, GREEN, RED, GREEN, END))
                    os._exit(1)
            else:
                print(
                "\n{}{}WARNUNG: Es gibt {}0 Hosts{} in ihrem Netzwerk.\n\tSieht aus wie ein Fehler {}:/{}".format(
                    GREEN, RED, GREEN, RED, GREEN, END))
                print(
                "\n{}Wenn dieser Fehler mehrmals auftritt, bitte melde ihn hier:\n\t{}https://github.com/k4m4/kickthemout/issues\n{}".format(
                    RED, BLUE, END))
                os._exit(1)

    else:
        print("\n{}Sie verwenden die Schnittstelle '{}{}{}' mit der Mac-Adresse '{}{}{}'.\nGateway IP: '{}{}{}' --> Target(s): '{}{}{}'.{}".format(
    ...
    if options.targets is None and options.scan is False:
        try:
            ...
            while True:
                ...
                header = ('{}testinput{}> {}'.format(BLUE, WHITE, END))
                choice = input(header)
                ...
                if choice.upper() == 'E' or choice.upper() == 'EXIT':
                    ...
                    print("\n{}ERROR: Bitte nehme eine gültige Option.{}\n".format(RED, END))
        ...
        stopAnimation = False
        t = threading.Thread(target=scanningAnimation, args=('Scannen des Netzwerkes bitte warten...',))
        t.daemon = True
        t.start()
...
if __name__ == '__main__':
    ...
    try:
        if checkInternetConnection():
            ...
            print("\n{}ERROR: Bitte überprüfe ob du Internet hast.{}\n".format(RED, END))
            os._exit(1)
    except KeyboardInterrupt:
        shutdown()
